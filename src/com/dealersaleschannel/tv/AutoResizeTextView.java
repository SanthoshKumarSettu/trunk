...
public class AutoResizeTextView extends TextView {
    ...
    private float mCalculatedTextSize = 0;
    ...
    //Set to true if you don't want to wrap text
    ...
    public AutoResizeTextView(Context context, AttributeSet attrs, int defStyle) {
        ...
        mCalculatedTextSize =  mTextSize;
    }

    public float getCalculatedTextSize()
    {
		return mCalculatedTextSize;
...
//    
    ...
    /**
     * Return flag to to wrap text or not
     * @return
     */
    ...
    public void resizeText(int width, int height) {
        ...
        mCalculatedTextSize =  targetTextSize;
    }
 ...
 // Set the text size of the text paint object and use a static layout to render text off screen before measuring
    private int getTextWidth(CharSequence source, TextPaint paint, float textSize) {
        ...
        paint.setTextSize(textSize);
        // Draw using a static layout
        StaticLayout layout = new StaticLayout(source, paint, 4096, Alignment.ALIGN_NORMAL, mSpacingMult, mSpacingAdd, true);
